...
- 날짜: 2026-08-18
- 상태: draft
- 한 줄: Gemini·Seedance로 콘티·컨펌까지 자동화하고 편집은 사람이 하는 운영안
...
- **팩트/출처 게이트** — 지식·투자·뉴스형이면 대본 컨펌 전에 주장마다 출처. 저장소의 [30년물·AI 자본 브리핑](../2026-08-18-us-30y-ai-capital/README.md)은 첫 파일럿 주제로 쓰기 좋다. 스킵하면 나중에 영상을 버려야 한다.
...
예시 파일은 `examples/`에 있다. 오케스트레이터는 이 JSON만 읽고 쓴다.
...
그다음 작업은 스타일 팩을 채우고, Gate A/B가 되는 리뷰 HTML과 Seedance I2V 호출을 붙이는 것이다. 스키마 예시는 `examples/`를 본다.
